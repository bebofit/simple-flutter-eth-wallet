...
import 'package:simplewallet/models/transaction.model.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const EmptyWidget(
                    ...
                    subtitle:
                        "simpleWallet is in the process of retrieving your transaction history, and as of now, it appears that there is no transaction history available in simpleWallet.",
                  );
                }
              },
            ),
